  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 pt-24 pb-20">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-extrabold text-[#1E1B4B] dark:text-white mb-2">Terms of Service</h1>
        ...
        <div className="prose prose-gray max-w-none text-gray-700 dark:text-gray-300 space-y-8">
          <section>
            <h2 className="text-xl font-bold text-[#1E1B4B] dark:text-white">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#1E1B4B] dark:text-white">2. Description of Service</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#1E1B4B] dark:text-white">3. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#1E1B4B] dark:text-white">4. No Warranties</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#1E1B4B] dark:text-white">5. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#1E1B4B] dark:text-white">6. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#1E1B4B] dark:text-white">7. Changes to Terms</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#1E1B4B] dark:text-white">8. Contact</h2>
            <p>Questions about these terms? Email <a href="mailto:hello@postowl.in" className="text-[#1E1B4B] dark:text-amber-400 underline">hello@postowl.in</a>.</p>
          </section>
        </div>
      </div>
    </div>
